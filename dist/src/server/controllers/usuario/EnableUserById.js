...
exports.enableUserById = exports.enableUserByIdValidation = void 0;
...
exports.enableUserByIdValidation = (0, Validation_1.validation)((getSchema) => ({
    params: getSchema(yup.object({
        id: yup.number().required().moreThan(0)
    }))
}));
const enableUserById = async (req, res) => {
    if (!req.params.id) {
    ...
    const result = await usuario_1.UsuarioProvider.enableUserById(req.params.id);
