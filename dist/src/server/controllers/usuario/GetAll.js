...
const getAll = async (req, res) => {
    const result = await usuario_1.UsuarioProvider.getAll(req.query.page || 1, req.query.limit || 10, req.query.filter || '', req.query.id ? Number(req.query.id) : 0);
    const count = await usuario_1.UsuarioProvider.count(req.query.filter);
