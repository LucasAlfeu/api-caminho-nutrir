...
exports.becomeAdmById = exports.becomeAdmByIdValidation = void 0;
...
exports.becomeAdmByIdValidation = (0, Validation_1.validation)((getSchema) => ({
    params: getSchema(yup.object({
        id: yup.number().required().moreThan(0)
    }))
}));
const becomeAdmById = async (req, res) => {
    if (!req.params.id) {
    ...
    const result = await usuario_1.UsuarioProvider.becomeAdmById(req.params.id);
