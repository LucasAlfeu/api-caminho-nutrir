...
exports.disableUserById = exports.disableUserByIdValidation = void 0;
...
exports.disableUserByIdValidation = (0, Validation_1.validation)((getSchema) => ({
...
const disableUserById = async (req, res) => {
    ...
    const result = await usuario_1.UsuarioProvider.disableUserById(req.params.id);
...
//# sourceMappingURL=DisableUserById.js.map