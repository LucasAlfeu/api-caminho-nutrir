...
exports.validadeRequestById = exports.validadeRequestByIdValidation = void 0;
...
exports.validadeRequestByIdValidation = (0, Validation_1.validation)((getSchema) => ({
...
const validadeRequestById = async (req, res) => {
    if (!req.params.id) {
    ...
    const result = await estacao_1.EstacaoProvider.validadeRequestById(req.params.id);
...
//# sourceMappingURL=ValidateRequestById.js.map