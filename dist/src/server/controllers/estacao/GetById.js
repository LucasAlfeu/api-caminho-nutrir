...
exports.getByIdValidation = (0, Validation_1.validation)((getSchema) => ({
...
const getById = async (req, res) => {
    ...
    const result = await estacao_1.EstacaoProvider.getById(req.params.id);
    ...
    const recuperaHistorico = await historico_1.HistoricoProvider.getAllByIdEstacao(result.id);
    ...
    const recuperaReporte = await reporte_1.ReporteProvidedr.getAllById(result.id);
